...
let defaultTimeTillCloseMs = 5000
let timeTillCloseMs = defaultTimeTillCloseMs
var intervalId = 0

function updateTimeTillCloseAndStart() {
  chrome.storage.sync.get(["delay"]).then((result) => {
    console.log(result)
    timeTillCloseMs = result.delay * 1000
